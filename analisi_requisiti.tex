...
\label{sec:req_analysis}
	...
	\subsection{Raccolta delle Informazioni}
		...
		\subsubsection{Documenti raccolti}
			...
			Le figure \ref{fig:doc_fattura}, \ref{fig:doc_gpl} e \ref{fig:doc_metano} presentano alcuni documenti che siamo riusciti a procurarci. Disponiamo di una fattura d'esempio e di due preventivi d'installazione.

			\begin{figure}
				\centering
				\includegraphics[width=13cm]{images/documents/fattura.png}
				\caption{Una fattura}
				\label{fig:doc_fattura}
			\end{figure}

			\begin{figure}
				\centering
				\includegraphics[width=13cm]{images/documents/preventivo_gpl.png}
				\caption{Un preventivo per l'installazione di un impianto gpl}
				\label{fig:doc_gpl}
			\end{figure}

			\begin{figure}
				\centering
				\includegraphics[width=13cm]{images/documents/preventivo_metano.png}
				\caption{Un preventivo per l'installazione di un impianto a metano}
				\label{fig:doc_metano}
			\end{figure}
	...
	\subsection{Glossario dei Termini}
		...
		\begin{longtable}{| p{2.5cm} | p{4.5cm} | p{2cm} | p{2.5cm} |}
			...
			\\ \hline
			Collaudo &
			Attività relativa alla verifica specifica del corretto funzionamento del serbatoio installato con il nuovo impianto (che sia a metano o gpl). Deve eseguito nuovamente ogni 5 anni. &&
			Autovettura
			\\ \hline
			Revisione & 
			Attività di verifica del corretto funzionamento dei tutte le parti dell’autovettura. Deve eseguita nuovamente ogni 5 anni.&&
			Autovettura
			\\ \hline
			Retribuzione Oraria & 
